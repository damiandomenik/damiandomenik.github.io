...
/**
 * Build an element. There is deliberately no innerHTML escape hatch here: file
 * names and page labels come from files the user opened, and the only way to
 * be sure they can never become markup is not to have the option.
 */
