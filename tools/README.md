...
4. Erreichbar unter `https://username.github.io/tools/`, die PDF-App unter `.../tools/pdf/`.

Alle Pfade sind relativ (`./pdf/`, `../`), es funktioniert also auch in einem
